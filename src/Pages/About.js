      ...
      <div className='flex flex-col gap-[15vh] min-h-fit border-orange-400 border-5 text-center pt-[9%] w-[90%]'>
            ...
            <div className='flex justify-between flex-row w-[100%] gap-[5%]'>
              <div className='text-left max-w-[40%] flex flex-col justify-between'>
                <div className='flex flex-col gap-[1rem]'>
                  ...
                  <h1> MEET OUR TEAM </h1>
                  <h3 className='mt-[1rem]'> Meet the team who's second savour whos seconr savour, boddy bodyt copy body copy</h3>
                </div>

                <div className='flex w-[50%] justify-between'>
                  <h3 className='h-[100%] flex flex-col justify-center text-gray-600'> Questions? Reach out</h3>
          ...
          <section className='grid grid-cols-2 gap-[5%]'>
            ...
            <div className='text-left grid grid-col'>
              ...
              <h3>Second Savour was founded by a group of friends at Simon Fraser University (SFU) with a mission to create and sustainable environmental change.</h3>
              <h3 className='text-gray-600'> Aspiring Changemakers </h3>
              <h3>We aimed to reduce supply chain waste by taking a different approach than companies that sell imperfect produce. We want to promote the use of the whole product and not leave waste. We do not dare to dream about a better world, we dare to enact the change.  </h3>
            </div>
          ...
          <section className='p-0 overflow-hidden overflow-x-hidden'>
            <div className='h-fit w-[100%] gap-[0.25rem] flex flex-row absolute m-0 left-0'>
              <div className=''><img src={scroll1} alt='scroll1' /></div>
              <div className=''><img  src={scroll2} alt='scroll2' /></div>
              <div className=''><img  src={scroll3} alt='scroll3' /></div>
            </div>
            ...
            <div className='text-left flex flex-row mt-[4%] gap-[2%]'> 
              <h3> <p>Words</p> <br></br>At Second Savour, we focus on reducing waste and promoting sustainability by utilizing surplus produce. By reducing the need for additional resources to create new food, we contribute to conserving energy, water, and soil health. Sustainability is more than a goal for us—it's the way we operate</h3>
              <h3> <p>Team Bond</p> <br></br>At Second Savour, we believe that a strong team is built on genuine connections and shared experiences. Our team socials are more than just events; they're a chance to bond, unwind, and celebrate our collective efforts. Join us, and become part of a family that values camaraderie as much as our mission to be sustainable</h3>
            </div>
          </section>
